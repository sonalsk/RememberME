import 'package:alzheimers_game/games/validLetters2.dart';
      ...
      body: Column(
        ...
        Expanded(
          ...
          child: Container(
            ...
            color: primaryTeal,
            child: Center(
              child: Text("Which of the following is an English Language Alphabet?", style: primaryFont),
            ),
          ),
        ),
        Expanded(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => ValidLetterCheck2()));
        },
      ),
    );
  }
