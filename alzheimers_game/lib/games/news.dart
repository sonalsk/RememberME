      ...
      body: Column(
        ...
        Expanded(
          ...
          child: Container(
            ...
            color: primaryTeal,
            child: Center(
              child: Text("Do you know about the current events or news about the world or what is going on with everyone in your house?", style: primaryFont),
            ),
          ),
        ),
        Expanded(
                      ...
                      RaisedButton(
                        ...
                        child: Padding(
                            ...
                            child: Container(
                              ...
                              height: 50.0,
                              width: width,
                              child: Text("I only know about what concerns me",
                                  style: GoogleFonts.signika(
                                      color: Colors.teal,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 22.0)),
