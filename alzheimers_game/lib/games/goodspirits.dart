      ...
      body: Column(children: [
        Expanded(
          ...
          child: Container(
            ...
            color: primaryTeal,
            child: Center(
              child: Text("Are you in good spirits most of the time?", style: primaryFont),
            ),
          ),
        ),
        Expanded(
                ...
                child: Row(
                    ...
                    children: [
                      RaisedButton(
                        ...
                        color: selected1 ? primaryTeal.withOpacity(.5) : white.withOpacity(.8),
                      ),
                      RaisedButton(
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(5.0),
                        ...
                        color: selected2 ? primaryTeal.withOpacity(.5) : white.withOpacity(.8),
                      )
                    ])),
          ),
        ),
